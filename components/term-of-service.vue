<template>
  <div class="term-of-service pb-6 pl-5 pr-6">
    <div>
    ...
    <div>１．法令または公序良俗に違反する行為</div>
    <div>２．犯罪行為に関連する行為</div>
    <div>
    ...
    <div>５．本サービスによって得られた情報を商業的に利用する行為</div>
    <div>６．当社のサービスの運営を妨害するおそれのある行為</div>
    <div>７．不正アクセスをし，またはこれを試みる行為</div>
    <div>８．他のユーザーに関する個人情報等を収集または蓄積する行為</div>
    <div>９．不正な目的を持って本サービスを利用する行為</div>
    <div>
      １０．本サービスの他のユーザーまたはその他の第三者に不利益，損害，不快感を与える行為
    </div>
    <div>１１．他のユーザーに成りすます行為</div>
    <div>
      １２．当社が許諾しない本サービス上での宣伝，広告，勧誘，または営業行為
    </div>
    <div>１３．面識のない異性との出会いを目的とした行為</div>
    <div>
    ...
    <div>・本サービスにかかるシステムの保守点検または更新を行う場合</div>
    <div>
      ・地震，落雷，火災，停電または天災などの不可抗力により，本サービスの提供が困難となった場合
    </div>
    <div>・システムまたは通信回線等が事故により停止した場合</div>
    ...
    <div>・当社からの連絡に対し，一定期間返答がない場合</div>
    ...
    <div>
      ...
      <a href="https://eggsystem.co.jp/privacy">
        「プライバシーポリシー」
      </a>
      に従い適切に取り扱うものとします。
    </div>
